      ...
      >
        <div className='left_content_wrapper'>
          <motion.h2>
            ...
            <motion.span variants={secondName} initial='initial' animate='animate' className='last'>
              <motion.span variants={letter}>S</motion.span>
          ...
          <motion.p variants={fadeInUp}>
            oioitj ojropt optkjrt optt pokjtrpojt topejtpwrtget opjtopt <br /> jpojfpo gjpogj prog rojgprg opjgog opjtpgorg opjr grgh
          </motion.p>
          ...
          <motion.div className='review_container' variants={stagger}>
            ...
            <motion.p className='more_review' variants={star}>More then 50+ peoples taking services</motion.p>
          </motion.div>
        </div>
